...
const projects: Project[] = [
  ...
  {
    title: "Portfolio",
    description: "Modern, responsive portfolio template built with React, TypeScript, and Tailwind CSS",
...
const Projects = () => {
  return (
    <section id="Project" className="py-16 px-4 bg-gradient-to-b from-slate-50 to-slate-100">
